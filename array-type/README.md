...
在之前的[章节](https://beatai.org/rust-course/basic/compound-type/string-slice#%E5%88%87%E7%89%87slice)，我们有讲到 `切片` 这个概念，它允许你引用集合中的部分连续片段，而不是整个集合，对于数组也是，数组切片允许我们**引用**数组的一部分：
